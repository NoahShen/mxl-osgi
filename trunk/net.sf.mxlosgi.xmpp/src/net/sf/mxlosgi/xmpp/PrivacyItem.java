...
public class PrivacyItem implements XMLStanza
{
	...
	public void setValue(String value)
	{
		...
		{
			if (!(value.equalsIgnoreCase(Subscription.both.name())
					|| value.equalsIgnoreCase(Subscription.from.name())
					|| value.equalsIgnoreCase(Subscription.none.name())
					|| value.equalsIgnoreCase(Subscription.to.name())))
			{
