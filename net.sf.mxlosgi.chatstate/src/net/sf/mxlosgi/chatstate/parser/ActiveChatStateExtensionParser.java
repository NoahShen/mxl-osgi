 ...
 * 
 */
public class ActiveChatStateExtensionParser implements ExtensionParser
{
	public static final String ELEMENTNAME = "active";
	
	public static final String NAMESPACE = "http://jabber.org/protocol/chatstates";
	
	public ActiveChatStateExtensionParser()
	{
	}
	...
	{
		ChatStateExtension chatstate = new ChatStateExtension(ChatStateExtension.ChatState.active);
