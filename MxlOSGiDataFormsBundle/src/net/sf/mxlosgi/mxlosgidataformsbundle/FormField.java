 ...
 * 
 */
public class FormField implements XMLStanza
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1553483974145167064L;
	...
	/**
	 * Creates a new FormField with the variable name that uniquely
	 * identifies the field in the context of the form.
	 * 
	 * @param variable
...
//		this.type = FormField.TYPE_FIXED;
	 ...
	 * <p>
	 * <p/> If the question is of type FIXED then the description should
	 * remain empty.
	 * 
	 * @return description that provides extra clarification about the
	 *         question.
	 */
	...
	/**
	 * Returns the label of the question which should give enough
	 * information to the user to fill out the form.
	 * 
	...
	/**
	 * Returns an Iterator for the available options that the user has in
	...
	/**
	 * Returns true if the question must be answered in order to complete
	 * the questionnaire.
	 * 
	 * @return true if the question must be answered in order to complete
	 *         the questionnaire.
	 */
	...
	/**
	 * Returns an indicative of the format for the data to answer. Valid
	 * formats are: <p/>
	 * <ul>
	 * <li>text-single -> single line or word of text
	 * <li>text-private -> instead of showing the user what they typed,
	 * you show ***** to protect it
	 ...
	 * <li>boolean -> 0 or 1, true or false, yes or no. Default value is
	 * 0
	 * <li>fixed -> fixed for putting in text to show sections, or just
	 * advertise your web site in the middle of the form
	 * <li>hidden -> is not given to the user at all, but returned with
	 * the questionnaire
	 ...
	 * question is part of a form to fill out. Otherwise, returns an
	 * Iterator for the answered values of the question.
	 * 
	 * @return an Iterator for the default values or answered values of
	 *         the question.
	 */
	...
	/**
	 * Sets a description that provides extra clarification about the
	 * question. This information could be presented to the user either in
	 * tool-tip, help button, or as a section of text before the question.
	 * <p>
	 * <p/> If the question is of type FIXED then the description should
	...
	/**
	 * Sets the label of the question which should give enough information
	 * to the user to fill out the form.
	 * 
	 * @param label
	 ...
	 * 
	 * @param required
	 *                  if the question must be answered in order to
	...
	/**
	 * Sets an indicative of the format for the data to answer. Valid
	 * formats are: <p/>
	 * <ul>
	 * <li>text-single -> single line or word of text
	 * <li>text-private -> instead of showing the user what they typed,
	 ...
	 * 
	 * @param type
	 *                  an indicative of the format for the data to
	 *                  answer.
	 */
	...
	/**
	 * Adds a default value to the question if the question is part of a
	 * form to fill out. Otherwise, adds an answered value to the
	 * question.
	 * 
	 * @param value
	 *                  a default value or an answered value of the
	 *                  question.
	 */
	...
	/**
	 * Adds a default values to the question if the question is part of a
	 * form to fill out. Otherwise, adds an answered values to the
	 * question.
	 * 
	 * @param newValues
	 *                  default values or an answered values of the
	 *                  question.
	 */
	...
	/**
	 * Adss an available options to the question that the user has in
	 * order to answer the question.
	 * 
	 * @param option
	...
	public String toXML()
	{
		...
		// Loop through all the values and append them to the string
		// buffer
	...
	public Object clone() throws CloneNotSupportedException
	{
		...
		field.variable = this.variable;
		field.type = this.type;
		
		field.options = new ArrayList<Option>();
		for (Option option : this.options)
		{
			field.options.add((Option) option.clone());
		}
	 ...
	 */
	public static class Option implements XMLStanza
	{

		/**
		 * 
		 */
		private static final long serialVersionUID = 7066055590778178021L;
